...
public class RouteController {
    ...
    public List<RouteGeometry> getRoutes() {
        ...
        for (Route r : routeRepository.findAll()) {
            ...
            // Da V24 le fermate della linea si leggono dal pattern, non da una
    ...
    public ResponseEntity<?> getShape(@PathVariable String id) {
        ...
        // di V24, o modificata a mano) i vertici in eccesso restano senza id e
     ...
     *
     * Fino a V24 questo endpoint RIFIUTAVA di cambiare le fermate, e con

...
public class RoadClosure {
    ...
    /**
     * The {@link #status} the fleet manager has already been shown a notice
     * for: {@code null} never, and while it differs from {@link #status}
     * there is a notice to show.
     */
    @Column(name = "acknowledged_status")
    private Boolean acknowledgedStatus;

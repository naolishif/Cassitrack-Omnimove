...
const OMNI_T = {
  en: {
    ...
    about_seeweb:'Partner providing the artificial intelligence that powers the assistant',
    ...
    eco_f_leg:'km of that leg',
    eco_info_s4_t:'Combined journeys',
    eco_info_s4_p:'A combined route mixes modes, so no single factor describes it. Each leg is charged at its own rate — the bus kilometres emit, the ones by bike, e-scooter or on foot do not — and the index is then worked out over the whole distance, clean kilometres included.',
    eco_info_s4_ex:'Example: 9.9 km by bus + 2.5 km by e-scooter + 0.5 km on foot emits 673 g and scores 69 — not the 879 g and 60 points the same distance would cost by bus alone.',
    ...
    eco_tip_5:'Prefer a 🔀 Combined route over the plain bus: the kilometres you cover by bike or e-scooter emit nothing and lift the index of the whole trip.',
    ...
    pwd_intro_set:'This account signs in with Google. Add a password if you also want to sign in with your email address.',
    pwd_current:'Current password',
    pwd_new:'New password',
    pwd_confirm:'Confirm new password',
    pwd_save:'Update password',
    pwd_save_first:'Set password',
    pwd_saved:'Password updated.',
    pwd_err_current:'Enter your current password.',
    pwd_err_required:'Enter a new password.',
    pwd_err_match:'The two passwords do not match.',
    pwd_err_generic:'Could not update the password.',
    pwd_forgot:'I forgot my password',
    pwd_reset_sent:'Link sent to {email}. It expires in one hour.',
    pwd_reset_sent_toast:'Reset link sent to your inbox.',
    // Standalone reset page (reached from the email link)
    tagline:'Smart mobility for Cassino — UNICAS 2025/2026',
    title_reset:'Reset your password',
    reset_link_dead:'This reset link has expired or is invalid.',
    reset_done:'Password updated!',
    reset_failed:'Reset failed.',
    btn_back_signin_short:'Back to login',
    pwd_rule_short:'Min 8 chars: uppercase, lowercase, number & special character',
    err_google_failed:'Google sign-in failed. Please try again.',
    err_captcha_required:'Please complete the "I\'m not a robot" check.',
    // Timetable
    nav_timetable:'Timetable',
    // Ranking profile & onboarding
    label_ranking:'Result ranking',
    label_modes:'Modes',
    desc_default_mode:'One at a time — this is the order, not a filter',
    opt_custom:'🎚 Custom',
    chip_custom:'🎚 Custom',
    edit_weights:'Edit the weights',
    q_time:'How important is arriving as fast as possible?',
    q_cost:'How important is spending as little as possible?',
    q_eco:'How important is travelling with low CO₂?',
    q_reliability:'Connections: wide margins or tight and quick?',
    q_rel_low:'Wide margins',
    q_rel_high:'Tight is fine',
    q_rain:'When it rains, suggest the bus?',
    q_rain_desc:'Bus first — the other options stay available',
    q_walk:'How far will you walk to a shared bike or a stop?',
    q_crowd:'Warn me about crowded buses?',
    pref_occupancy_over:'Over {pct}% full',
    w_time:'Time',
    w_cost:'Cost',
    w_eco:'CO₂',
    w_reliability:'Margins',
    ob_t1:'What matters on a journey?',
    ob_s1:'Drag each one. We turn the answers into how results are ranked.',
    ob_t2:'Connections and weather',
    ob_s2:'Two quick ones.',
    ob_t3:'Walking and crowding',
    ob_s3:'Last one.',
    ob_next:'Next',
    ob_done:'Done',
    ob_skip:'Skip this one',
    ob_skip_last:'Skip and finish',
    ob_saved:'Profile saved — results now follow your answers.',
    tt_title:'Timetable',
    tt_lines:'Lines',
    tt_direction:'Direction',
    tt_hint:'Stops down the side, runs across the top — scroll sideways for later runs.',
    tt_hint_short:'Swipe sideways for later runs →',
    tt_stop:'Stop',
    ...
    pref_avoid_occupancy:'Warn me about crowded buses',
    ...
    pref_ebike:'Show bike before bus',
    desc_ebike:'An ordering preference — bus options are never removed',
    pref_rain:'Suggest the bus when it rains',
    desc_rain:'Bus options come first. Bike, scooter and walking stay available.',
    // Settings – Notifications
    label_notifications:'Notifications',
    pref_apply_presets:'Apply the options below to Fast, Budget and Eco too',
    desc_apply_presets:'Off: they shape Custom only, and the other three answer their one question unfiltered',
    alert_delay_grew:'⚠️ Your line is now {min} min late',
    alert_connection_risk:'⚠️ You may miss your connection — running {min} min short',
    alert_connection_ok:'✓ Connection back within reach — {min} min to spare',
    pref_delay_alerts:'Route delay alerts',
    desc_delay_alerts:'While a started journey is running, we tell you if your line falls further behind',
    label_live_journey:'While travelling',
    pref_live_position:'Show my position on the route',
    desc_live_position:'Once a journey starts, an arrow on the drawn route shows where you are along it, and we notice when you reach your destination. Your position stays on this device — it is never sent or saved. Turn it off and, while a journey is running, nothing will say where you are relative to the route, and arrival will only be declared when you tap End Journey or when the time runs out.',
    arrival_title:'You have arrived',
    arrival_body:'You are at {dest}. The journey has been closed for you.',
    timeup_title:'Time is up',
    timeup_body:'The time estimated for this journey has run out. If you are still on your way, tap Resume — your card stays exactly as it is and the trip is not counted a second time.',
    btn_resume:'Resume',
    ai_place_unknown:'I could not find "{name}" among the stops — pick it on the map and I will plan from there.',
    ai_reco_label:'The assistant suggests',
    ai_start_title:'Start this journey?',
    ai_start_body:'The assistant picked {opt} — {why}. It will not start until you say so.',
    ai_start_cancelled:'Not started. The suggestion is still on the card.',
    ai_started_for_you:'Journey started for you by the assistant',
    ai_replan_title:'End the journey you are on?',
    ai_replan_body:'You are travelling to {dest}. Planning another journey closes this one — what it has already recorded is kept, but the map, the timer and the delay alerts go.',
    ai_replan_yes:'Plan the new one',
    ai_replan_cancelled:'Journey kept. Nothing was re-planned.',
    ai_why_FAST:'the fastest — {v} min',
    ai_why_FAST_worst:'the slowest — {v} min',
    ai_why_CHEAP:'the cheapest — €{v}',
    ai_why_CHEAP_worst:'the priciest — €{v}',
    ai_why_ECO:'the greenest — {v}/100',
    ai_why_ECO_worst:'the least green — {v}/100',
    ai_why_CUSTOM:'the best match for your profile',
    ai_why_CUSTOM_worst:'the worst match for your profile',
    ai_why_mode:' by {mode}',
    err_offline:'No answer from the server — check your connection and try again.',
    err_rejected:'The search was refused (error {status}). Try changing the filters.',
    err_server:'The server could not plan this journey (error {status}). Please try again.',
    err_render:'The routes arrived but could not be displayed. The details are in the browser console.',
    legend_you:'You are here — the arrow points the way the route runs',
    msg_too_soon:'You have just written to us. You can send another message in a few minutes.',
    toggle_search_hide:'Hide',
    toggle_search_open:'Search',
    toggle_search:'Hide the search fields and give the map the screen',
    toggle_search_show:'Show the search fields again',
    routes_updated:'Times updated at {time}',
    routes_updating:'Updating times…',
    toast_journey_resumed:'Journey resumed — {min} more minutes on the clock',
    btn_finished:'I have finished',
    btn_ok:'OK',
    // Settings – Save
    ...
    hazard_popup:'Ongoing emergency reported by the partner systems — this route passes near it',
    badge_change:'1 change · {min} min to catch it',
    ...
    pick_on_map:'Choose a point on the map',
    btn_clear_search:'Clear origin, destination and results',
    pick_map_origin:'Tap the map to set your starting point',
  ...
  it: {
    ...
    about_seeweb:'Partner che fornisce l\'intelligenza artificiale che alimenta l\'assistente',
    ...
    eco_f_leg:'km di quella tappa',
    eco_info_s4_t:'Viaggi combinati',
    eco_info_s4_p:'Un percorso combinato mette insieme più mezzi, quindi non esiste un fattore unico che lo descriva. Ogni tappa paga la propria tariffa — i chilometri in bus emettono, quelli in bici, monopattino o a piedi no — e l\'indice si calcola poi sull\'intera distanza, chilometri puliti compresi.',
    eco_info_s4_ex:'Esempio: 9,9 km in bus + 2,5 km in monopattino + 0,5 km a piedi emettono 673 g e valgono 69 punti, non gli 879 g e i 60 punti che la stessa distanza costerebbe in solo bus.',
    ...
    eco_tip_5:'Preferisci un percorso 🔀 Combinata al solo bus: i chilometri che fai in bici o monopattino non emettono e alzano l\'indice di tutto il viaggio.',
    ...
    pwd_intro_set:'Questo account accede con Google. Aggiungi una password se vuoi entrare anche con il tuo indirizzo email.',
    pwd_current:'Password attuale',
    pwd_new:'Nuova password',
    pwd_confirm:'Conferma nuova password',
    pwd_save:'Aggiorna password',
    pwd_save_first:'Imposta password',
    pwd_saved:'Password aggiornata.',
    pwd_err_current:'Inserisci la password attuale.',
    pwd_err_required:'Inserisci una nuova password.',
    pwd_err_match:'Le due password non coincidono.',
    pwd_err_generic:'Impossibile aggiornare la password.',
    pwd_forgot:'Ho dimenticato la password',
    pwd_reset_sent:'Link inviato a {email}. Scade tra un\'ora.',
    pwd_reset_sent_toast:'Link di reimpostazione inviato alla tua email.',
    // Pagina di reset autonoma (si arriva dal link nell'email)
    tagline:'Mobilità intelligente per Cassino — UNICAS 2025/2026',
    title_reset:'Reimposta la password',
    reset_link_dead:'Questo link di reimpostazione è scaduto o non è valido.',
    reset_done:'Password aggiornata!',
    reset_failed:'Reimpostazione non riuscita.',
    btn_back_signin_short:'Torna al login',
    pwd_rule_short:'Min 8 caratteri: maiuscola, minuscola, numero e carattere speciale',
    err_google_failed:'Accesso con Google non riuscito. Riprova.',
    err_captcha_required:'Completa la verifica \"Non sono un robot\".',
    // Orari
    nav_timetable:'Orari',
    // Profilo di ordinamento e onboarding
    label_ranking:'Ordinamento dei risultati',
    label_modes:'Mezzi',
    desc_default_mode:'Uno alla volta — è l\'ordine, non un filtro',
    opt_custom:'🎚 Personalizzata',
    chip_custom:'🎚 Personalizzata',
    edit_weights:'Modifica i pesi',
    q_time:'Quanto è importante arrivare il più velocemente possibile?',
    q_cost:'Quanto è importante spendere il meno possibile?',
    q_eco:'Quanto è importante viaggiare a basse emissioni di CO₂?',
    q_reliability:'Coincidenze: margini ampi o strette e veloci?',
    q_rel_low:'Margini ampi',
    q_rel_high:'Strette va bene',
    q_rain:'Quando piove, ti consigliamo il bus?',
    q_rain_desc:'Bus per primo — le altre opzioni restano disponibili',
    q_walk:'Quanto sei disposto a camminare per una bici condivisa o una fermata?',
    q_crowd:'Avvisami sui bus affollati?',
    pref_occupancy_over:'Oltre il {pct}% di occupazione',
    w_time:'Tempo',
    w_cost:'Costo',
    w_eco:'CO₂',
    w_reliability:'Margini',
    ob_t1:'Cosa conta per te in un viaggio?',
    ob_s1:'Trascina ogni cursore. Trasformiamo le risposte nell\'ordine dei risultati.',
    ob_t2:'Coincidenze e meteo',
    ob_s2:'Due domande veloci.',
    ob_t3:'Camminata e affollamento',
    ob_s3:'Ultima.',
    ob_next:'Avanti',
    ob_done:'Fatto',
    ob_skip:'Salta questa',
    ob_skip_last:'Salta e chiudi',
    ob_saved:'Profilo salvato — i risultati seguono le tue risposte.',
    tt_title:'Orari',
    tt_lines:'Linee',
    tt_direction:'Direzione',
    tt_hint:'Fermate in verticale, corse in orizzontale — scorri di lato per le corse successive.',
    tt_hint_short:'Scorri di lato per le corse successive →',
    tt_stop:'Fermata',
    ...
    pref_avoid_occupancy:'Avvisami sui bus affollati',
    ...
    pref_ebike:'Mostra la bici prima del bus',
    desc_ebike:'È una preferenza di ordine — il bus non viene mai escluso',
    pref_rain:'Con la pioggia consigliaci il bus',
    desc_rain:'Il bus viene per primo. Bici, monopattino e piedi restano disponibili.',
    // Settings – Notifications
    label_notifications:'Notifiche',
    pref_apply_presets:'Applica le opzioni sotto anche a Veloce, Economico ed Eco',
    desc_apply_presets:'Spento: valgono solo per Personalizzata, e le altre tre rispondono alla loro domanda senza filtri',
    alert_delay_grew:'⚠️ La tua linea è ora in ritardo di {min} min',
    alert_connection_risk:'⚠️ Rischi di perdere la coincidenza — mancano {min} min',
    alert_connection_ok:'✓ Coincidenza di nuovo raggiungibile — {min} min di margine',
    pref_delay_alerts:'Avvisi ritardo percorso',
    desc_delay_alerts:'Ricevi notifiche quando il tuo percorso ha un ritardo',
    label_live_journey:'Durante il viaggio',
    pref_live_position:'Mostra la mia posizione sul percorso',
    desc_live_position:'Quando inizi un viaggio, una freccetta sul percorso disegnato indica dove ti trovi lungo di esso, e ci accorgiamo quando arrivi a destinazione. La posizione resta su questo dispositivo: non viene mai inviata né salvata. Se la disattivi, durante un viaggio nulla ti dirà dove ti trovi rispetto al percorso, e l\'arrivo sarà dichiarato solo quando premi Termina viaggio o allo scadere del tempo.',
    arrival_title:'Sei arrivato',
    arrival_body:'Sei a {dest}. Il viaggio è stato chiuso automaticamente.',
    timeup_title:'Tempo scaduto',
    timeup_body:'Il tempo previsto per questo viaggio è terminato. Se sei ancora in viaggio tocca Riprendi: la scheda resta com\'è e il viaggio non viene contato una seconda volta.',
    btn_resume:'Riprendi',
    ai_place_unknown:'Non trovo "{name}" tra le fermate — indicala sulla mappa e pianifico da lì.',
    ai_reco_label:'L\'assistente consiglia',
    ai_start_title:'Avviare questo viaggio?',
    ai_start_body:'L\'assistente ha scelto {opt} — {why}. Non parte finché non lo dici tu.',
    ai_start_cancelled:'Non avviato. Il consiglio resta sulla card.',
    ai_started_for_you:'Viaggio avviato per te dall\'assistente',
    ai_replan_title:'Chiudere il viaggio in corso?',
    ai_replan_body:'Stai viaggiando verso {dest}. Pianificare un altro viaggio chiude questo: quello che ha gi\u00e0 registrato resta, ma mappa, contatore e avvisi di ritardo vanno via.',
    ai_replan_yes:'Pianifica il nuovo',
    ai_replan_cancelled:'Viaggio mantenuto. Non ho ripianificato nulla.',
    ai_why_FAST:'la più veloce — {v} min',
    ai_why_FAST_worst:'la più lenta — {v} min',
    ai_why_CHEAP:'la più economica — €{v}',
    ai_why_CHEAP_worst:'la più cara — €{v}',
    ai_why_ECO:'la più ecologica — {v}/100',
    ai_why_ECO_worst:'la meno ecologica — {v}/100',
    ai_why_CUSTOM:'la migliore per il tuo profilo',
    ai_why_CUSTOM_worst:'la peggiore per il tuo profilo',
    ai_why_mode:' in {mode}',
    err_offline:'Nessuna risposta dal server — controlla la connessione e riprova.',
    err_rejected:'Ricerca rifiutata (errore {status}). Prova a cambiare i filtri.',
    err_server:'Il server non è riuscito a calcolare il percorso (errore {status}). Riprova.',
    err_render:'I percorsi sono arrivati ma non è stato possibile mostrarli. I dettagli sono nella console del browser.',
    legend_you:'Sei qui — la freccia indica il verso del percorso',
    msg_too_soon:'Ci hai appena scritto. Puoi inviare un altro messaggio fra qualche minuto.',
    toggle_search_hide:'Nascondi',
    toggle_search_open:'Cerca',
    toggle_search:'Nascondi i campi di ricerca e lascia lo schermo alla mappa',
    toggle_search_show:'Mostra di nuovo i campi di ricerca',
    routes_updated:'Orari aggiornati alle {time}',
    routes_updating:'Aggiornamento orari…',
    toast_journey_resumed:'Viaggio ripreso — altri {min} minuti sul contatore',
    btn_finished:'Ho finito',
    btn_ok:'OK',
    // Settings – Save
    ...
    lbl_departing_at:'in partenza alle',
    ...
    hazard_popup:'Emergenza in corso segnalata dai sistemi partner — questo percorso ci passa vicino',
    badge_change:'1 cambio · {min} min per prenderlo',
    ...
    pick_on_map:'Scegli un punto sulla mappa',
    btn_clear_search:'Svuota origine, destinazione e risultati',
    pick_map_origin:'Tocca la mappa per scegliere il punto di partenza',
